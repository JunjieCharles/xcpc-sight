...
2025–2026 赛季来自 `icpc2025` 和 `ccpc2025`；2026–2027 赛季对应 `icpc2026` 和 `ccpc2026`，当前已发布网络赛第一、第二场选手 Rating 与赛后复盘，并提供上述两场及 CCPC 网络预选赛的三场赛前前瞻，尚未发布本赛季题目难度；新赛季 Rating 从 1400 独立起算。两个正式赛季都按统一规则排除邀请赛、保留区域赛，并按上海本地日期排序。
